package com.tairanchina.zt.oss;
...
public class SimpleGetObjectSample {
    ...
    private static String accessKeyId = "LTAIBv8quoSY8Ray";
    private static String accessKeySecret = "IxRjdwfGaFfYR6U2CXDUUpENSGSomf";
    private static String bucketName = "zt-oss";
    private static String key = "file-0001";
...
//            client.createBucket(bucketName);
            ...
            BucketInfo bucketInfo = client.getBucketInfo("trcloud-mongdb");
